...
def create_index(collection):
   print(fmt.format("Start Creating index IVFPQ"))
   index = {
        "index_type": "IVF_PQ",
        "metric_type": "L2",
...
def measure_build_times_inc(collection, schema, wb, num_vectors):
    print("\n=== Build times ===")
    build_times = []
...
if __name__ == "__main__":
    ...
    build_times = measure_build_times_inc(sift1m_collection, schema, wb, num_vectors)
